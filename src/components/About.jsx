        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-full max-w-md mx-auto">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-br from-primary-400 to-primary-600 rounded-3xl"
              ></motion.div>
          ...
          >
            ...
            >
              <a 
                href="#contact" 
                className="inline-flex items-center px-6 py-3 bg-primary-600 text-white rounded-full font-medium hover:bg-primary-700 transition-all duration-300"
              >
                Let's Talk
              ...
              <a 
                href="/cv.pdf" 
                download
                className="inline-flex items-center px-6 py-3 border-2 border-primary-600 text-primary-600 rounded-full font-medium hover:bg-primary-50 transition-all duration-300"
              >
